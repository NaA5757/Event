<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ref_event_types.aspx.cs" Inherits="Ref_event_type" %>
...
<body bgcolor="464866">
    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" ForeColor="White" Text="Event Type Code"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" ForeColor="White" Text="Event Type Description"></asp:Label>
                </td>
                <td>
