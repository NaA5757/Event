<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Organizers.aspx.cs" Inherits="Organizers" %>
...
<body bgcolor="2d283e">
    ...
    <div>
         ...
         <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" PostBackUrl="~/MyMenu.aspx">MyMenu</asp:LinkButton>
         <br />
        <br />
