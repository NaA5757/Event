    ...
    <div>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tderived_days_duration" runat="server" class="t"
                        ></asp:TextBox>
                </td>
            </tr>
            <tr>
         ...
         <br />
        <asp:LinkButton ID="LinkButton1" runat="server"  PostBackUrl="~/MyMenu.aspx" OnClick="LinkButton1_Click"  OnClientClick="aspnetForm.target ='_blank';" >MyMenu</asp:LinkButton>
        <br />
         <br />
        <br />
